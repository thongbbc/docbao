...
- (void)viewDidLoad {
    ...
    NSURL *url=[[NSURL alloc] initWithString:@"http://tuoitre.vn/rss/tt-kinh-te.rss"];
...
{
    CellBao *cell=[collectionView dequeueReusableCellWithReuseIdentifier:@"cell3" forIndexPath:indexPath];
