...
- (void)viewDidLoad {
    ...
    NSURL *url=[[NSURL alloc] initWithString:@"http://tuoitre.vn/rss/tt-van-hoa-giai-tri.rss"];
...
{
    CellBao *cell=[collectionView dequeueReusableCellWithReuseIdentifier:@"cell5" forIndexPath:indexPath];
