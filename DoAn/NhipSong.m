...
- (void)viewDidLoad {
    ...
    NSURL *url=[[NSURL alloc] initWithString:@"http://tuoitre.vn/rss/tt-nhip-song-so.rss"];
...
{
    CellBao *cell=[collectionView dequeueReusableCellWithReuseIdentifier:@"cell6" forIndexPath:indexPath];
