...
- (void)viewDidLoad {
    ...
    NSURL *url=[[NSURL alloc] initWithString:@"http://tuoitre.vn/rss/tt-giao-duc.rss"];
...
{
    CellBao *cell=[collectionView dequeueReusableCellWithReuseIdentifier:@"cell4" forIndexPath:indexPath];
