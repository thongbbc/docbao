...
- (void)viewDidLoad {
    ...
    NSURL *url=[[NSURL alloc] initWithString:@"http://tuoitre.vn/rss/tt-tin-moi-nhat.rss"];
...
{
    CellBao *cell=[collectionView dequeueReusableCellWithReuseIdentifier:@"cell1" forIndexPath:indexPath];
